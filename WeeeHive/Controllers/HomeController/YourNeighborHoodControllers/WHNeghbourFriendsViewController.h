//
//  WHNeghbourFriendsViewController.h
//  WeeeHive
//
...
@interface WHNeghbourFriendsViewController : UIViewController
...
@property (nonatomic,strong) NSString *gettingUserId;
@property (nonatomic,strong) NSString *weehiveName;
