...
@protocol WHLoginDetailsModel <NSObject>
@end

@interface WHLoginDetailsModel : JSONModel
...
@property (nonatomic,strong) NSString *verification_code;
...
@property (nonatomic,strong) NSString *address_entered;
